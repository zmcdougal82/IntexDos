...
echo -e "${BLUE}================================================${NC}"
echo -e "${GREEN}✓ SparkPost domain 'mail.cineniche.co' is verified${NC}"
echo -e "${GREEN}✓ Password reset emails will be delivered to users${NC}"
echo -e "${BLUE}================================================${NC}"
...
echo -e "1. Check the Azure application logs for errors - look for SparkPost API responses"
...
echo -e "4. Check your spam/junk folder as emails from new domains may be filtered"
echo ""
