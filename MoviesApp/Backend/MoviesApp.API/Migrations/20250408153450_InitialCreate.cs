        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DisneyPlus = table.Column<int>(type: "INTEGER", nullable: true),
                    ParamountPlus = table.Column<int>(type: "INTEGER", nullable: true),
                    Max = table.Column<int>(type: "INTEGER", nullable: true),
                    Hulu = table.Column<int>(type: "INTEGER", nullable: true),
                    AppleTVPlus = table.Column<int>(type: "INTEGER", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AnimeSeriesInternationalTVShows = table.Column<int>(type: "INTEGER", nullable: true),
                    BritishTVShowsDocuseriesInternationalTVShows = table.Column<int>(type: "INTEGER", nullable: true),
                    Children = table.Column<int>(type: "INTEGER", nullable: true),
                    Comedies = table.Column<int>(type: "INTEGER", nullable: true),
                    ComediesDramasInternationalMovies = table.Column<int>(type: "INTEGER", nullable: true),
                    ComediesInternationalMovies = table.Column<int>(type: "INTEGER", nullable: true),
                    ComediesRomanticMovies = table.Column<int>(type: "INTEGER", nullable: true),
                    CrimeTVShowsDocuseries = table.Column<int>(type: "INTEGER", nullable: true),
                    Documentaries = table.Column<int>(type: "INTEGER", nullable: true),
                    DocumentariesInternationalMovies = table.Column<int>(type: "INTEGER", nullable: true),
                    Docuseries = table.Column<int>(type: "INTEGER", nullable: true),
                    Dramas = table.Column<int>(type: "INTEGER", nullable: true),
                    DramasInternationalMovies = table.Column<int>(type: "INTEGER", nullable: true),
                    DramasRomanticMovies = table.Column<int>(type: "INTEGER", nullable: true),
                    FamilyMovies = table.Column<int>(type: "INTEGER", nullable: true),
                    Fantasy = table.Column<int>(type: "INTEGER", nullable: true),
                    HorrorMovies = table.Column<int>(type: "INTEGER", nullable: true),
                    InternationalMoviesThrillers = table.Column<int>(type: "INTEGER", nullable: true),
                    InternationalTVShowsRomanticTVShowsTVDramas = table.Column<int>(type: "INTEGER", nullable: true),
                    KidsTV = table.Column<int>(type: "INTEGER", nullable: true),
                    LanguageTVShows = table.Column<int>(type: "INTEGER", nullable: true),
                    Musicals = table.Column<int>(type: "INTEGER", nullable: true),
                    NatureTV = table.Column<int>(type: "INTEGER", nullable: true),
                    RealityTV = table.Column<int>(type: "INTEGER", nullable: true),
                    Spirituality = table.Column<int>(type: "INTEGER", nullable: true),
                    TVAction = table.Column<int>(type: "INTEGER", nullable: true),
                    TVComedies = table.Column<int>(type: "INTEGER", nullable: true),
                    TVDramas = table.Column<int>(type: "INTEGER", nullable: true),
                    TalkShowsTVComedies = table.Column<int>(type: "INTEGER", nullable: true),
